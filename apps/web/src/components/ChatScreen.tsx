...
import { Send, ShoppingBag, ChefHat } from "lucide-react";
...
export default function ChatScreen({ sessionId, onOrderPlaced }: Props) {
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      id: "welcome",
      role: "assistant",
      content: "أهلاً وسهلاً بك في مطعم الأصالة 🌙 كيف أقدر أخدمك اليوم؟",
    },
  ]);
